...
const Bloge = () => {
  return (
    <div className="mt-10" id="blogs">
      <AppLayout>
        <h1 className="text-center font-bold text-[35px] mb-6 text-white">
          Our Blogs
        </h1>
          ...
          <div>
            {BlogeMock.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="lg:w-[300px] w-[320px] sm:w-[220px] lg:h-[480px] h-[400px] sm:h-[400px] rounded-md border bg-[#45342C]  lg:ml-0 sm:ml-0 gap-4">
                  ...
                  <div className="p-4">
                    ...
                    <p className="lg:mt-[130px] mt-14 sm:mt-13 w-full  text-[16px] lg:text-[14px] sm:text-[10px] text-[#FFF] ">
                      {" "}
